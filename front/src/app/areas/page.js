        ...
        <section className="w-full bg-amber-50 py-16">
            <div className="w-full">
                ...
                <div className="flex flex-wrap justify-center items-center">
                    {areas.map((a) => (
                        <div key={a.id} className="bg-[#ffffff] shadow-md shadow-black/40 p-5 mx-10 my-5 w-80 h-40 flex flex-col items-center rounded-md hover:scale-105 hover:shadow-2xl transition-all duration-200 ease-in-out">
